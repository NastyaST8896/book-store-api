...
export class AddBooksInUserCart1773658531236 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "books_rating" DROP CONSTRAINT "PK_4b21c9909785d9eb59f4b6e67b0" PRIMARY KEY ("id")`);
        await queryRunner.query(`ALTER TABLE "books_rating" ADD CONSTRAINT "PK_d3fe65b4cb5121d8bcb886b45fb"`);
